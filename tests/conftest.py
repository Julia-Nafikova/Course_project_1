...
@pytest.fixture
def number():
    return [{'Дата операции': '31.01.2019 13:34:15', 'Дата платежа': '31.01.2019', 'Номер карты': None, 'Статус': 'OK', 'Сумма операции': -35.0, 'Валюта операции': 'RUB', 'Сумма платежа': -35.0, 'Валюта платежа': 'RUB', 'Кэшбэк': None, 'Категория': 'Мобильная связь', 'MCC': None, 'Описание': 'Teletie Бизнес +7 966 000-00-00', 'Бонусы (включая кэшбэк)': 0, 'Округление на инвесткопилку': 0, 'Сумма операции с округлением': 35.0}]

@pytest.fixture
def category():
    return [{'Дата операции': '16.01.2018 12:16:11', 'Дата платежа': '17.01.2018', 'Номер карты': '*7197', 'Статус': 'OK', 'Сумма операции': -289.0, 'Валюта операции': 'RUB', 'Сумма платежа': -289.0, 'Валюта платежа': 'RUB', 'Кэшбэк': None, 'Категория': 'Фастфуд', 'MCC': 5814.0, 'Описание': 'OOO Frittella', 'Бонусы (включая кэшбэк)': 5, 'Округление на инвесткопилку': 0, 'Сумма операции с округлением': 289.0}, {'Дата операции': '15.01.2018 12:36:29', 'Дата платежа': '16.01.2018', 'Номер карты': '*7197', 'Статус': 'OK', 'Сумма операции': -209.0, 'Валюта операции': 'RUB', 'Сумма платежа': -209.0, 'Валюта платежа': 'RUB', 'Кэшбэк': None, 'Категория': 'Фастфуд', 'MCC': 5814.0, 'Описание': 'OOO Frittella', 'Бонусы (включая кэшбэк)': 4, 'Округление на инвесткопилку': 0, 'Сумма операции с округлением': 209.0}]
...
def sample_data():
    ...
    data = {
        ...
        "Дата платежа": ["06.10.2021","06.10.2021", "17.01.2018", "06.10.2021", "17.01.2018"],
